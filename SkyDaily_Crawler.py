...
urls = [
    ...
    'https://www.skyedaily.com/news/news_list21.html',
    'https://www.skyedaily.com/news/news_list30.html?mode=ct&m_section=4',
    'https://www.skyedaily.com/news/news_list30.html?mode=ct&m_section=5',
    'https://www.skyedaily.com/news/news_list30.html?mode=ct&m_section=40',
    'https://www.skyedaily.com/news/news_list30.html?mode=ct&m_section=2',
    'https://www.skyedaily.com/news/news_list30.html?mode=ct&m_section=51',
    'https://www.skyedaily.com/news/news_list30.html?mode=ct&m_section=30',
    'https://www.skyedaily.com/news/news_list30.html?mode=ct&m_section=6'
]

processed_links = set()
last_parsed_time = datetime(2020, 1, 1)
...
def is_new_article(article_time):
    return article_time > last_parsed_time
...
def process_article(element):
    ...
    if title_element and time_element:
        ...
        try:
            ...
            try:
                published_time = datetime.strptime(time_str, '%Y.%m.%d')
                formatted_time = published_time.isoformat()
            except ValueError:
                return None
        ...
        text_content = title
        if is_relevant_article(text_content) and is_new_article(published_time):
